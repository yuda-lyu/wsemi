...
describe(`composeTreeObj`, function() {
    ...
    let crArr = `[{"id":1,"text":"1-a"},{"id":2,"text":"2-b","children":[{"id":3,"text":"3-c","parentId":2,"children":[{"id":5,"text":"5-e","parentId":3}]},{"id":4,"text":"4-d","parentId":2}]},{"id":6,"text":"empty"}]`

    it(`should return ${crArr} when input ${JSON.stringify(arr)}`, function() {
        let r = composeTreeObj(arr)
        r = JSON.stringify(r)
        let rr = crArr
        assert.strict.deepStrictEqual(r, rr)
    })
