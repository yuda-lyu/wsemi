...
describe(`getdtv`, function() {
    ...
    it(`should return '678' when input { a: 123, b: ['x', 'y', { aa: null, bb: ['mn', { cc: 45, dd: '678' }] }], c: '45op', d: null }, 'b[2].bb[1].dd'`, function() {
        let r = getdtv({ a: 123, b: ['x', 'y', { aa: null, bb: ['mn', { cc: 45, dd: '678' }] }], c: '45op', d: null }, 'b[2].bb[1].dd')
        let rr = '678'
        assert.strict.deepEqual(r, rr)
    })
