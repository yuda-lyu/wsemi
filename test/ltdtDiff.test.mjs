...
describe(`ltdtDiff`, function() {
    ...
    if (true) {
        ...
        let r2out = { 'diff': [{ 'count': 1, 'added': false, 'removed': true, 'value': '0∶1⟋1∶⟋2∶0.506002098⟋3∶∗empty∗⟋\n' }, { 'count': 1, 'added': true, 'removed': false, 'value': '0∶1⟋1∶∗empty∗⟋2∶0.506002098⟋3∶⟋\n' }], 'dfs': [{ 'cn': { 'p': '', 'k': 'cn', 'vo': '1', 'vn': '' }, 'v1': { 'p': 'modify', 'k': 'v1', 'vo': '', 'vn': '∗empty∗' }, 'v3': { 'p': '', 'k': 'v3', 'vo': '0.506002098', 'vn': '' }, 'v2': { 'p': 'modify', 'k': 'v2', 'vo': '∗empty∗', 'vn': '' } }] }
        k++
        kp[k] = {
            oin1: r2in1,
            oin2: r2in2,
