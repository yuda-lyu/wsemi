...
describe('arrpull', function() {
    ...
    it("sould return ['abc'] when input ['abc'], [1]", function() {
        let r = arrpull(['abc'], [1])
        let rr = ['abc']
        assert.strict.deepEqual(r, rr)
    })
    ...
    it("sould return [] when input ['abc'], ''", function() {
        let r = arrpull(['abc'], '')
        let rr = []
        assert.strict.deepEqual(r, rr)
    })
    ...
    it("sould return [] when input ['abc'], null", function() {
        let r = arrpull(['abc'], null)
        let rr = []
        assert.strict.deepEqual(r, rr)
    })

    it("sould return [] when input ['abc'], undefined", function() {
