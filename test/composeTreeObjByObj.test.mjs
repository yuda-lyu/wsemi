...
import composeTreeObjByObj from '../src/composeTreeObjByObj.mjs'


describe(`composeTreeObjByObj`, function() {
    ...
    it(`should return [] when input null`, function() {
        let r = composeTreeObjByObj(null)
        let rr = []
        assert.strict.deepStrictEqual(r, rr)
    })

    it(`should return [] when input undefined`, function() {
        let r = composeTreeObjByObj(undefined)
        let rr = []
        assert.strict.deepStrictEqual(r, rr)
    })
