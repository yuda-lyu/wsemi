...
describe('time2min', function() {
    ...
    it(`should return '' when input '2019/01/01 12:34:56:789'`, function() {
        let r = time2min('2019/01/01 12:34:56:789')
        assert.strict.deepEqual(r, '')
    })

    it(`should return '' when input '2019/01/01 12:34:66:789'`, function() {
        let r = time2min('2019/01/01 12:34:66:789')
        assert.strict.deepEqual(r, '')
    })

    it(`should return '2019/01/01 12:34' when input '2019/01/01 12:34:56'`, function() {
        let r = time2min('2019/01/01 12:34:56')
        assert.strict.deepEqual(r, '2019/01/01 12:34')
    })

    it(`should return '' when input '2019/01/01 12:34:66'`, function() {
        let r = time2min('2019/01/01 12:34:66')
        assert.strict.deepEqual(r, '')
    })

    it(`should return '' when input '2019/21/01 12:34:56'`, function() {
        let r = time2min('2019/21/01 12:34:56')
        assert.strict.deepEqual(r, '')
    })
