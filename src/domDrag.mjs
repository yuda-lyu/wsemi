 ...
 * @param {String} [opt.attIdentify='dragid'] 輸入預覽元素唯一識別用字串，預設'dragid'
 * @param {String} [opt.attIndex='dragindex'] 輸入預覽元素順序指標字串，預設'dragindex'
 * @param {String} [opt.attGroup='draggroup'] 輸入預覽元素群組字串，預設'draggroup'
 ...
 *
 * //監聽dom
 * let dd = domDrag(document.querySelector('#id'), { attIndex: 'dragindex' })
 *
 * //change
 * dd.on('change', (msg) => {
