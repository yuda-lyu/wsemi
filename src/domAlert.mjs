 ...
 * @param {String} [opt.paddingStyle='14px 26px 14px 14px'] 輸入內寬設定字串，預設'14px 26px 14px 14px'
...
function domAlert(msg, opt = {}) {
    ...
    //paddingStyle
    let paddingStyle = get(opt, 'paddingStyle', '14px 26px 14px 14px')
    paddingStyle = replace(paddingStyle, ';', '')
    ...
    >
        <div style="position:relative; padding:${paddingStyle};">
