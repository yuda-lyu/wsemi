 ...
 * @returns {String|Object} 回傳秒時間字串，t非有效毫秒時間字串或轉換失敗時回傳空字串；若opt.returnWithStateAndMsg為true則回傳{ state, msg }物件
 * @example
 *
...
function timemsTZ2time(t, opt = {}) {
    ...
    try {
        ...
        let d = ot(t)
        r = d.format('YYYY-MM-DDTHH:mm:ss')
