...
/**
 * 由vall陣列各元素物件提取指定keys欄位出來成為新的物件陣列，若物件不存在keys的欄位時，則會自動填入指定數據def
 *
 * Unit Test: {@link https://github.com/yuda-lyu/wsemi/blob/master/test/arrmapping.test.js Github}
 * @memberOf wsemi
 ...
 * // ]
 */
function arrmapping(vall, keys, def = '') {
