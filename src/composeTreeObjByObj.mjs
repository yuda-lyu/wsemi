 ...
 * 組合項目物件陣列成為樹狀物件
 *
 * Unit Test: {@link https://github.com/yuda-lyu/wsemi/blob/master/test/composeTreeObjByObj.test.mjs Github}
 * @memberOf wsemi
 ...
 *
 */
function composeTreeObjByObj(obj, opt = {}) {
    ...
    //composeTreeObjByArr
    let nodes = composeTreeObjByArr(arrObj, {
        bindKey,
        bindParent,
        bindChildren,
        saveExtProps,
...
export default composeTreeObjByObj
